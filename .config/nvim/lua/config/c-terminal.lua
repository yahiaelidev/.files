local M = {}
-- This variable will hold the terminal's state and will not be reset.
local Term_job_id = 0
...
--   group = vim.api.nvim_create_augroup('custom-norm-open')
--   callback = function()
...
--   t_job_id = vim.bo.channel
--
-- end)
-- vim.keymap.set("n", "<space>run", function()
--   vim.bo.chansend(t_job_id, {"echo 'hi'\r\n"})
-- end)
--
